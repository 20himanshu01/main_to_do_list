document.addEventListener('DOMContentLoaded', function() {
    // Clear input content from local storage when the DOM is loaded
    localStorage.removeItem("daily_content");
    localStorage.removeItem("weekly_content");
    localStorage.removeItem("monthly_content");
    localStorage.removeItem("yearly_content");
    ...
    containers.forEach(function(container) {
        ...
        if (savedContent) {
            ...
            taskInput.value = ''; // Set empty value if no saved content
        }
